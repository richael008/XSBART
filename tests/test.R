...
time = proc.time()
fit = XSBART(as.matrix(y), as.matrix(x), as.matrix(xtest), p_categorical = dcat,
            ...
            num_cutpoints = params$num_cutpoints, parallel = parl, random_seed = 100, no_split_penality = params$no_split_penality,ctType=1,
RepeatT=6,
StepSize=40,
MHB=FALSE,
NWB=FALSE,
